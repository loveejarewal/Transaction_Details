...
namespace jQuery_Ajax_CRUD.Controllers
{
    public class TransactionController : Controller
    {
        ...
        public async Task<IActionResult> AddOrEdit(int id, [Bind("TransactionId,AccountNumber,BeneficialName,BankName,SWIFTCode,Amount,Date")] TransactionModel transactionModel)
        {
